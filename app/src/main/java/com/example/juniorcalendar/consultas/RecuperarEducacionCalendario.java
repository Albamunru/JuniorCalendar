...
public class RecuperarEducacionCalendario extends AsyncTask<String, Void, String> {
    ...
    public RecuperarEducacionCalendario(Context context, TaskCompleted listener) {
    ...
    protected String doInBackground(String... params) {
       ...
       String fechaConvertida= utiles.formatearFecha(fecha);
        ...
        try {
            ...
            String query = "?fecha=" + URLEncoder.encode(fechaConvertida, "UTF-8")
                    + "&email=" + URLEncoder.encode(email, "UTF-8");
            URL url = new URL("http://10.0.2.2/RecuperarEducacionCalendario.php" + query);
