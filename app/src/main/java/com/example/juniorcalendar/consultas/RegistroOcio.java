...
public class RegistroOcio extends AsyncTask<String, Void, String> {
    ...
    public RegistroOcio(Context context, TaskCompleted listener) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            String query = "?fecha_actividad=" + URLEncoder.encode(fecha, "UTF-8")
                    + "&hora=" + URLEncoder.encode(hora, "UTF-8")
                    + "&nombre_actividad=" + URLEncoder.encode(nombre, "UTF-8")
            ...
            URL url = new URL("http://10.0.2.2/InsertarOcio.php" + query);
