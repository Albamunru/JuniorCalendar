...
public class RecuperarOcioCalendario extends AsyncTask<String, Void, String> {
    ...
    public RecuperarOcioCalendario(Context context, TaskCompleted listener) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            String query = "?fecha_actividad=" + URLEncoder.encode(fechaConvertida, "UTF-8")
                    + "&email=" + URLEncoder.encode(email, "UTF-8");
            URL url = new URL("http://10.0.2.2/RecuperarOcioCalendario.php" + query);
